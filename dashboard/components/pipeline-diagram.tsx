    ...
    <div className="relative rounded-2xl border border-white/[0.06] bg-[#0e0e10] p-3 pt-5 md:p-8 shadow-[0_1px_2px_rgba(0,0,0,0.3)]">
      <div className="relative space-y-1">
        ...
        <PipelineNode
          ...
          tag="human gate"
          title="Portal YES gate"
          subtitle='Click YES on the portal modal → order auto-transmits to market. No TWS-side click.'
          files={["transmit=true", "portal click = single gate"]}
        />
