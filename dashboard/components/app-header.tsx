          ...
          <Link href="/" className="flex items-center gap-3 transition-opacity hover:opacity-80">
            ...
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                <h1 className="text-base md:text-lg font-semibold tracking-tight leading-none text-[#e4e4e7] flex items-baseline gap-2">
                  <AvalgoWordmark />
                  <span className="text-[#e4e4e7]">
                    Cro<span className="text-[#c8a978]">$$</span>hair 0DTE Options
                  </span>
                </h1>
                <ModeBadge />
              </div>
